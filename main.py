...
imagepx = PhotoImage(file=r"2.png")
pabelp=Label(fc, image=imagepx)
imagepxz = PhotoImage(file=r"lacr (1).png")
imagepxz1 = PhotoImage(file=r"lacr (2) (1).png")
imageula = PhotoImage(file=r"conf (1).png")
...
imagepp= PhotoImage(file=r"7.png")
...
imagepxx = PhotoImage(file=r"IN (2) (1).png")
...
imagedasy= PhotoImage(file=r"his (2) (1).png")
...
imagedasx= PhotoImage(file=r"his (1).png")
...
imagedasz= PhotoImage(file=r"TRANS (1).png")
...
images= PhotoImage(file=r"9.png")
...
imagescs= PhotoImage(file=r"confirmar (2) (1).png")
...
imaged= PhotoImage(file=r"10.png")
...
imaget= PhotoImage(file=r"11.png")
...
imagetx= PhotoImage(file=r"confirmar (2) (2).png")
...
imageh= PhotoImage(file=r"12.png")
...
imagev= PhotoImage(file=r"4.png")
...
imager= PhotoImage(file=r"5.png")
